...
| `DATALAB_BASE_URL` | No | Datalab base URL. Defaults to `https://www.datalab.to` |
...
3. The adapter polls the check URL every 3 s until `status == true` or the 300 s deadline is reached.
